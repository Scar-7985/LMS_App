...
const InvoiceView = () => {
    ...
    return (
        <>
            <Header profile={true} title={'Invoice View'} showSearch={false} rightSec={
                <div
                    onClick={handlePrint}
            ...
            <div className="container mt-3" id="PDFInvoice" style={{ paddingBottom: '100px' }}>
                <div className="card shadow py-2">
                    <div className="card-body">
                        <div id="invoice" className="p-h-30">
                            <div className="m-t-15 lh-2 d-flex justify-content-between">
                                <div>
